...
def strat_fictitious_play(p, x_init, y_init, nb_lignes, nb_cols, pos_restaurants, nb_restos, nb_jours, historique_config):
    """
    ...
    print("Chemin trouvé:", shortest_path)

    return choix_resto, shortest_path